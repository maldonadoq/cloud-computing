...
public class DriverClass{
    ...
    public static void main(String[] arg) throws Exception {
        ...
        ToolRunner.run(new Configuration(), new LinkGraph(), arg);
        ...
        for(int i=1;i<=noOfRuns;i++){
            ...
            ToolRunner.run(new Configuration(),new PageRank(), arg);
        }

        //Sorting the pages based on the page rank value
        ToolRunner.run(new Configuration(),new PageRankSorting(), arg);

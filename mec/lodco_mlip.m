...
while t <= T
    ...
    for i = 1: N        
        ...
        %% step 1.2: get the (initial) optimal computation offloading strategy
        ...
        if zeta == 0
            ...
            %% step 1.2.1: solve the optimization problem
            ...
            %% step 1.2.2: solve the optimization problem
...
for t = 2: T
    if final_chosen_cost(t, i) == 0
        average_ratio(t, :) = average_ratio(t-1, :);
        continue
    else
        request_num = request_num + 1;
...
title('Evolution of average ratio of chosen modes')
xlabel('Time slot')
ylabel('Average  ratio of chosen modes')
